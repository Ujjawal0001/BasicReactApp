      ...
      <nav className="border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="hidden lg:flex items-center lg:order-2">
            ...
            <Link
              to="#"
              className="text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2.5 focus:outline-none"
            >
              Get started
            </Link>
          </div>
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              {['/', '/about', '/contact', '/github'].map((path, index) => {
                const labels = ['Home', 'About', 'Contact Us', 'Github'];
                return (
                  <li key={path}>
                    <NavLink
                      to={path}
